...
class PHPTemplateProjectNS_PassThroughStorage
extends PHPTemplateProjectNS_Component
implements EarthIT_CMIPREST_Storage
{
	protected $backingStorage;
	
	public function __construct( PHPTemplateProjectNS_Registry $reg, EarthIT_CMIPREST_Storage $backing ) {
	...
	use PHPTemplateProjectNS_StorageBonub;
}
