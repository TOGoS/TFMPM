...
class TFMPM_PageAction_ShowSchemaUpgrades extends TFMPM_PageAction_TemplatePageAction
{
	protected $mode;
	
	public function __construct( TFMPM_Registry $reg, $mode='list' ) {
