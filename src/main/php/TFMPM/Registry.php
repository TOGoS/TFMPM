...
class TFMPM_Registry
{
	...
	public function loadStorageHelper() {
		return new TFMPM_NormalStorageHelper($this);
	}
	...
	protected function loadStorage() {
		return new TFMPM_HJPKFixingStorage($this, $this->sqlStorage);
	}
	...
	public function loadMailer() {
		...
		if( $recipientOverride = coalesce($transportConfig['recipient-override']) ) {
			$transport = new TFMPM_Email_RecipientOverrideTransport($transport, $recipientOverride);
		}
