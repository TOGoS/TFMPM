...
class PHPTemplateProjectNS_PageAction_FileUploadTest extends PHPTemplateProjectNS_TestCase
{
	...
	protected function _testUpload($testOptions, $constructorOptions, array $requestSuperglobals=array()) {
		...
		$req = new PHPTemplateProjectNS_Request($requestSuperglobals);

		$act = new PHPTemplateProjectNS_PageAction_FileUpload($this->registry, $req, $constructorOptions);
