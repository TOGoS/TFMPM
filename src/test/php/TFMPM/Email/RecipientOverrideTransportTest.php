...
class TFMPM_Email_RecipientOverrideTransportTest
extends TFMPM_TestCase
{
	...
	public function setUp() {
		$this->cTransport = new TFMPM_Email_CollectorTransport();
		$this->roTransport = new TFMPM_Email_RecipientOverrideTransport(
